...
void MPU6050::setIntDataReadyEnabled(bool enabled) {
    char data[1];
    this->read(MPU6050_RA_INT_ENABLE, data, 1);
    data[0] = data[0] | (1 << MPU6050_INTERRUPT_DATA_RDY_BIT);
    this->write(MPU6050_RA_INT_ENABLE, data[0]);
}

int MPU6050::getIntStatus() {
    char data[1];
    this->read(MPU6050_RA_INT_STATUS, data, 1);
    return (int) data[0];
}
